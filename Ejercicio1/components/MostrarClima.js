...
import { Text, TextInput, View, StyleSheet, TouchableWithoutFeedback, Button, Image}
from 'react-native';
      ...
      {data.cod != 404 ? (
        <React.Fragment>
          <View style={styles.box}>
            ...
            <Text style={styles.highlow1}>{Math.floor(data.main.temp_max - 273.15)}/
                      {Math.floor(data.main.temp_min - 273.15)}</Text>
